...
git_folder_location='C:\Users\lgolebiewski\Repos\ML-Studio'   #replace with the local root folder location where you want to create the project folder
project_name=Mlops-LG   #replace with your project name
